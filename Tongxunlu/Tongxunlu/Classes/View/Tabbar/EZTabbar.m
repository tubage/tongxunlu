...
-(void)setBackgroundImage:(NSString *)backgroundImage{
    self._barPanel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:backgroundImage]];
}

-(void)setSelectedBackgroundImage:(NSString *)selectedBackgroundImage{
    self._selectedImageView.image = [UIImage imageNamed:selectedBackgroundImage];
}
...
-(void)setShowUpImage:(NSString *)image{
    ...
    self._showUpView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:image]];
}
